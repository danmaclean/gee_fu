...
) ENGINE=MyISAM AUTO_INCREMENT=64427 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=7558 DEFAULT CHARSET=latin1;
...
CREATE TABLE `experiments` (
  ...
  `uses_bam_file` tinyint(1) DEFAULT '0',
  `bam_file_path` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `external_db_old` (
  ...
  `priority` int(11) NOT NULL,
  `db_display_name` varchar(255) DEFAULT NULL,
  `type` enum('ARRAY','ALT_TRANS','ALT_GENE','MISC','LIT','PRIMARY_DB_SYNONYM','ENSEMBL','IGNORE') DEFAULT NULL,
  `secondary_db_name` varchar(255) DEFAULT NULL,
  `secondary_db_table` varchar(255) DEFAULT NULL,
  `description` text,
  PRIMARY KEY (`external_db_id`)
...
CREATE TABLE `features` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `seqid` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `strand` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phase` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `group` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `gff_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `experiment_id` int(11) NOT NULL,
  `sequence` text COLLATE utf8_unicode_ci,
  `read_id` text COLLATE utf8_unicode_ci,
  `quality` text COLLATE utf8_unicode_ci,
  `reference_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_features_on_ref_exp_start_and_end` (`experiment_id`,`seqid`,`start`,`end`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE `features_parents` (
  `feature_id` int(11) DEFAULT NULL,
  `parent_id` int(11) DEFAULT NULL,
  KEY `index_features_parents_on_feature_id_and_parent_id` (`feature_id`,`parent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `genomes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `build_version` text COLLATE utf8_unicode_ci,
  `meta` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `object_xref` (
  ...
  UNIQUE KEY `object_type_idx` (`ensembl_object_type`,`ensembl_id`,`xref_id`,`analysis_id`),
  KEY `oxref_idx` (`object_xref_id`,`xref_id`,`ensembl_object_type`,`ensembl_id`),
  KEY `xref_idx` (`xref_id`,`ensembl_object_type`),
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=757557 DEFAULT CHARSET=latin1;
...
CREATE TABLE `organisms` (
  ...
  `pv` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `parents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_feature` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_parents_on_parent_feature` (`parent_feature`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=11008 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=54 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=136597 DEFAULT CHARSET=latin1;
...
CREATE TABLE `unmapped_reason_old` (
...
) ENGINE=MyISAM AUTO_INCREMENT=661826 DEFAULT CHARSET=latin1;

INSERT INTO schema_migrations (version) VALUES ('20100814191202');

INSERT INTO schema_migrations (version) VALUES ('20100908000000');