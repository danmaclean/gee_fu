class RegistrationsController < Devise::RegistrationsController
	...
	def create
		...
		webApolloOutputThree = `sudo -u postgres #{WebApolloPath}/tools/user/set_track_permissions.pl -D #{WebApolloDatabase} -U #{WebApolloDatabaseUsername} -P #{WebApolloDatabasePassword} -r -w -u #{email} -t /opt/WebApollo/data/scratch/seqids.txt`
